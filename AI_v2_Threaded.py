...
class AI2(object):
    ...
    def bentMove(self, startRow, startCol, destRow, destCol, mType):
        self.board.state[startRow][startCol].bentMove(destRow, destCol, mType)
    ...
    def fireprocess(self, i, isWhite, branchBest, nRep=0):
        T = bT.BentThread(i, "Tester", isWhite, branchBest, nRep, self)
        return T.start()
...
if __name__ == "__main__":
    CB = SM.Board()
    bent = AI2(CB)
    bent.fireThread(1, True, -1000)
    bent.fireThread(2, True, -1000)
    bent.fireThread(3, True, -1000)
    bent.fireThread(4, True, -1000)
    bent.fireThread(5, True, -1000)
    bent.fireThread(6, True, -1000)
